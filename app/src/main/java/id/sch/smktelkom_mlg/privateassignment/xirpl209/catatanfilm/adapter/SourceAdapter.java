package id.sch.smktelkom_mlg.privateassignment.xirpl209.catatanfilm.adapter;
...
import id.sch.smktelkom_mlg.privateassignment.xirpl209.catatanfilm.R;
...
public class SourceAdapter extends RecyclerView.Adapter<SourceAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.tvTanggal.setText(result.release_date);
        Glide.with(context)
